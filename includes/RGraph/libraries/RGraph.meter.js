    ...
    */
    RGraph.Meter = function (id, min, max, value)
    {
        ...
        */
        ...
        this.properties = {
            'chart.background.color':       '#E6E6E6', //'white',//'#E6E6E6',//
            'chart.gutter.left':            10,
            'chart.gutter.right':           10,
            'chart.gutter.top':             10,
            'chart.gutter.bottom':          10,
            'chart.linewidth':              0,
          ...
          ///  'chart.title.bold':             false,
           ...
           // 'chart.title.valign':           'bottom',
            'chart.green.start':            ((this.max - this.min) * 0.35) + this.min,
            'chart.green.end':              this.max,
            //'chart.green.color':            '#604A7B',
            'chart.yellow.start':           ((this.max - this.min) * 0.1) + this.min,
            'chart.yellow.end':             ((this.max - this.min) * 0.35) + this.min,
            //'chart.yellow.color':           '#B3A2C7',
            'chart.red.start':              this.min,
            'chart.red.end':                ((this.max - this.min) * 0.1) + this.min,
           // 'chart.red.color':              '#0DC167',
            //'chart.colors.ranges':          0,
          //  'chart.units.pre':              '',
          //  'chart.units.post':             '',
            'chart.contextmenu':            null,
            'chart.zoom.factor':            1.5,
            'chart.zoom.fade.in':           false,
            'chart.zoom.fade.out':          false,
           // 'chart.zoom.hdir':              'center',
           // 'chart.zoom.vdir':              'top',
            'chart.zoom.frames':            25,
            'chart.zoom.delay':             16.66,
            'chart.zoom.shadow':            false,
            'chart.zoom.background':        false,
            ...
            'chart.shadow.blur':            3,
            'chart.shadow.offsetx':         1,
            'chart.shadow.offsety':         1,
            'chart.resizable':              false,
            'chart.resize.handle.adjust':   [0,0],
            'chart.resize.handle.background': null,
            'chart.tickmarks.small.num':      0,
            'chart.tickmarks.big.num':        0,
