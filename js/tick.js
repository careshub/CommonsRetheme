  ...
  Tick = (function() {
    ...
    function Tick(element, options) {
      ...
      this.options = {
		...
		stopnum: options.stopnum || 1000000000000
      };
      this.increment = this.build_increment_callback(options.incremental, options.stopnum);
    ...
    Tick.prototype.build_increment_callback = function(option, mb) {
