...
(function () {
    ...
    function Chart(containerId, options, externalReference) {
        ...
        if (this.creditText && this.creditHref) {
            ...
            this._creditLink.setAttribute("style", "outline:none;margin:0px;position:relative;right:3px;top:" + (height - 14) + "px;color:dimgrey;text-decoration:none;font-size:10px;font-family:Lucida Grande, Lucida Sans Unicode, Arial, sans-serif");
            ...
            if (this.isDrag) {
                ...
                if (Math.abs(dragDelta) > 2) {
                    if (this.panEnabled) {
                        ...
                        if (this.axisX.sessionVariables.internalMinimum < this.axisX._relativeMinimum) {

                            overFlow = this.axisX._relativeMinimum - this.axisX.sessionVariables.internalMinimum;

                            this.axisX.sessionVariables.internalMinimum += overFlow;
                            this.axisX.sessionVariables.internalMaximum += overFlow;
                            reRender = true;
                        } else if (this.axisX.sessionVariables.internalMaximum > this.axisX._relativeMaximum) {

                            overFlow = this.axisX.sessionVariables.internalMaximum - this.axisX._relativeMaximum;
                            this.axisX.sessionVariables.internalMaximum -= overFlow;
                            this.axisX.sessionVariables.internalMinimum -= overFlow;
        ...
        if (this.isDrag && this.plotInfo.axisPlacement !== "none") {
            ...
            if (Math.abs(dragDelta) > 2 && (this.panEnabled || this.zoomEnabled)) {
                if (this.panEnabled) {
                    ...
                    // This is to stop the user from dragging chart beyond some limit (this.axisX._relativeMinimum - this.axisX.interval)
                    if (this.axisX.sessionVariables.internalMinimum < this.axisX._relativeMinimum - convertToNumber(this.axisX.interval, this.axisX.intervalType)) {

                        overFlow = (this.axisX._relativeMinimum - convertToNumber(this.axisX.interval, this.axisX.intervalType)) - this.axisX.sessionVariables.internalMinimum;
                        this.axisX.sessionVariables.internalMinimum += overFlow;
                        this.axisX.sessionVariables.internalMaximum += overFlow;
                    } else if (this.axisX.sessionVariables.internalMaximum > this.axisX._relativeMaximum + convertToNumber(this.axisX.interval, this.axisX.intervalType)) {
                        overFlow = this.axisX.sessionVariables.internalMaximum - (this.axisX._relativeMaximum + convertToNumber(this.axisX.interval, this.axisX.intervalType));
                        this.axisX.sessionVariables.internalMaximum -= overFlow;
                        this.axisX.sessionVariables.internalMinimum -= overFlow;
                    }
    ...
    function Axis(chart, options, type, position) {
        ...
        this._relativeMinimum = null;// Used to determine boundaries while Zooming/Panning
        this._relativeMaximum = null;// Used to determine boundaries while Zooming/Panning
    ...
    Axis.prototype.calculateAxisParameters = function () {
        ...
        if (this.type === "axisX") {
            this._relativeMinimum = this._options && typeof (this._options.minimum) !== "undefined" ? this._options.minimum : this.dataInfo.min - minDiff / 2;
            this._relativeMaximum = this._options && typeof (this._options.maximum) !== "undefined" ? this._options.maximum : this.dataInfo.max + minDiff / 2;
        }
