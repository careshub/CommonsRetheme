...
<?php
 ...
 ?>
	...
	body.login #login h1 a {
	    background: url( <?php echo get_stylesheet_directory_uri() . '/img/ccommons-logo-login.png'; ?> ) no-repeat scroll center top transparent !important;
	    height: 90px;
	    width: 323px;
	}
	</style>
...
<body class="login">
	...
	<div id="login">
		...
		<h1><a href="/" title="<?php bloginfo('name'); ?>" tabindex="-1"><?php bloginfo('name'); ?></a></h1>
