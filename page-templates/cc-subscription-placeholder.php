...
?>
		<style>
			...
			<p>In addition to our Hubs, Community Commons is preparing to roll out a Subscription Service to give users even more options when it comes to making the tools on the Commons more meaningful for your local community change efforts.</p>
			<p>Until now, only our Hubs had access to the tool that allows them to add their own data into the Commons. Due to high demand from individual users, we’re making these tools available to everyone through a subscription service.</p>
