	...
	<div id="primary" class="site-content">
		<div id="content" role="main" class="content-container">
			...
			<section id="feature-stories" class="clear">
				...
				<p class="section-intro-outset">Learn how others are creating healthy, sustainable communities via our <a href="<?php echo $blog_url; ?>">feature stories</a>.</p>
				<div class="row clear">
					<?php 
			...
			<section id="maps-data" class="maps-data clear">
				<header>
					...
					<div class="banner-text">
						<h3 class="text-shadow-dark"><a href="/maps-data/">Explore</a></h3>
						<p class="section-intro-inset">Dig deeper to explore and visualize the unique realities of your own community using our <a href="/maps-data/">data, maps, reports and tools</a>.</p>
					</div>
				</header>
				<p class="section-intro-outset">Visualize the unique realities of your community using our <a href="/maps-data/">data, maps, reports and tools</a>.</p>
				<div class="row clear">
					<?php 
				    $data_args =  array( 
			...
			<section id="connect" class="clear">
				<?php $groups_url =  bp_get_groups_directory_permalink(); ?>
				<header>
					<div class="img-shadow">
						<?php 
						$img_url = get_stylesheet_directory_uri() . '/img/front-page/explore-maps';
					...
					<div class="banner-text">
						...
						<p class="section-intro-inset">Share your work, your questions and your successes with others in a <a href="<?php echo $groups_url; ?>">Hub</a>.</p>
					</div>
				</header>
				<p class="section-intro-outset">Share your work, your questions and your successes with others in a <a href="<?php echo $groups_url; ?>">Hub</a>.</p>
				<div class="row clear">
					<?php
					...
					if ( bp_has_groups( $group_args ) ) :
						...
						<div class="third-block compact">
							...
							<span class="group-type-flag"><?php bp_group_type();?></span>
